...
const Creators = () => {
  const creatorArray = [
    {
      img: "./creator/img-one.png",
      text: "Keepitreal",
    },
    {
      img: "./creator/img-two.png",
      text: "DigiLab",
    },
    {
      img: "./creator/img-three.png",
      text: "GravityOne",
    },
    {
      img: "./creator/img-four.png",
      text: "Juanie",
    },
    {
      img: "./creator/img-five.png",
      text: "BlueWhale",
    },
    {
      img: "./creator/img-six.png",
      text: "mr fox",
    },
    {
      img: "./creator/img-seven.png",
      text: "Shroomie",
    },
    {
      img: "./creator/img-eight.png",
      text: "robotica",
    },
    {
      img: "./creator/img-nine.png",
      text: "RustyRobot",
    },
    {
      img: "./creator/img-ten.png",
      text: "animakid",
    },
    {
      img: "./creator/img-11.png",
      text: "Dotgu",
    },
    {
      img: "./creator/img-12.png",
      text: "Ghiblier",
    },
  ];
  ...
  return (
    <div className="stanWidth">
      <div className=" flex flex-col md:flex-row mb-9 md:mb-0 md:items-center justify-between">
        <div>
          <h3 className=" font-bold text-4xl">Top Creators</h3>
        ...
        <div>
          <button className=" w-full md:w-fit flex items-center gap-3 border-2 border-[#844eca] text-white text-lg px-10 py-3  rounded-2xl">
            <svg
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
        {creatorArray.map((v, i) => (
          <div
            key={i}
            className="relative  flex flex-col items-center justify-center bg-[#3b3b3b] py-7 px-2 rounded-3xl"
          >
            <div className="   h-32 w-32 rounded-full mb-4">
              <img src={v.img} className=" w-full" alt="" />
            </div>

            <h4 className=" font-semibold text-white text-xl mb-2">{v.text}</h4>
            <div className=" flex items-center justify-center gap-2">
              <span className="block text-lg  text-[#858584]">
                Total Sales:
              </span>
              <span className=" block space-mono text-white text-lg">
                34.53 ETH
              </span>
            </div>

            <span className=" bg-[#2b2b2b] rounded-full text-xl  space-mono absolute  top-5 left-5 text-[#858584] w-7 h-7 flex items-center justify-center">
              {i + 1}
            </span>
          </div>
        ))}
