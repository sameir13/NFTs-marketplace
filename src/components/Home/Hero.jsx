...
import { stats } from "@/src/constant";
    ...
    <div>
      <div className="    grid grid-cols-1 md:grid-cols-2 gap-10 stanWidth items-center  justify-items-center md:justify-items-start  ">
        ...
        <div className="max-w-full md:max-w-[80%]">
          ...
          <button className=" hidden md:flex w-full  justify-center  py-4 px-8 items-center gap-4 text-white  text-md bg-[#a259ff] rounded-lg md:w-fit mb-7 ">
            <svg
          ...
          <div className=" hidden  md:grid grid-cols-3 gap-3">
            {stats.map((v, i) => (
              <div className=" flex flex-col  gap-2" key={i}>
                <h4 className="text-white space-mono text-3xl">{v.count}</h4>
                <span className=" text-white font-thin">{v.title}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        <div>
          <div
            ref={cardRef}
            className="w-fit rounded-3xl overflow-hidden shadow-lg"
          >
            <div ref={imageRef}>
            ...
            <div className=" py-6 px-5 bg-[#3b3b3b] ">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className=" text-white text-sm">Animakid</span>
              </div>
            </div>
          </div>
        </div>

        <button className="flex w-full  justify-center  py-4 px-8 items-center gap-4 text-white  text-md bg-[#a259ff] rounded-lg md:w-fit mb-7 md:hidden ">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20"
            height="20"
